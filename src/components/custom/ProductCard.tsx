...
export function ProductCard({
	...
	return (
		<div
			className={`group relative w-full bg-white rounded-2xl overflow-hidden transition-all duration-300 border border-gray-200/60 hover:shadow-lg transition-shadow ${className}`}
		>
			<div
