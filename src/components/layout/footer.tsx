		...
		<footer className="w-full mt-24">
			<div className="max-w-[1720px] mx-auto px-4 md:px-6 lg:px-8 my-6">
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16 border-t-2 border-dashed py-12">
					<div className="space-y-6">
						...
						<p className="text-base text-gray-600 leading-relaxed">
							...
							reprehenderit magni consequuntur magnam ab soluta incidunt, error numquam.
						</p>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						<div className="space-y-4">
							<h3 className="text-xl font-semibold">Akses Cepat</h3>
						...
						<div className="space-y-4">
							<h3 className="text-xl font-semibold">Kategori Produk</h3>
							<ul className="space-y-3">
					...
					<div className="space-y-6">
						...
						<div className="space-y-4">
							...
							<div className="flex items-center gap-3">
								...
								<p className="text-gray-600 text-sm">sinar.plastik@gmail.com</p>
							</div>
						</div>
					</div>
				</div>
				...
				<div className="flex flex-col md:flex-row justify-between items-center gap-4">
					<p className="text-gray-500 text-sm">© 2025 Nopall. All rights reserved.</p>
